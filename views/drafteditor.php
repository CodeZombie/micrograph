...
<div class="container">
		...
		<div class="col-md-9">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Edit draft</h3>
				</div>
				<div class="panel-body">
					<form method="post" action="<?php $_SERVER['SCRIPT_NAME'] ?>?action=savedraftedit&id=<?php echo $id; ?>">
						...
						<fieldset>	
							...
							<div class="panel panel-default no-border-radius panel-under-content-field">
								<input id="posttags" name="post_tags" type="text" class="form-control" placeholder="Tags, Seperated, By, Commas" <?php echo 'value="' . $post_tags_value . '"'; ?>>
							</div>
							<div class="panel panel-default no-border-top-radius panel-under-tag-field">
								<div class="btn-group">
									...
									<a class="btn btn-danger" href="<?php $_SERVER['SCRIPT_NAME'] ?>?action=deletedraft&id=<?php echo $id; ?>">Delete draft</a>
								</div>
							</div>
						</fieldset>
					</form>
